...
fn test_task3_sst_filter() {
    ...
    println!("test num iterators: {}", iter.num_active_iterators());
    ...
    let iter = storage
        ...
        .unwrap();
    println!("test2 num iterators: {}", iter.num_active_iterators());
    ...
    let iter = storage
        ...
        .unwrap();
    println!("test3 num iterators: {}", iter.num_active_iterators());
    ...
    let iter = storage
        ...
        .unwrap();
    println!("test4 num iterators: {}", iter.num_active_iterators());
    assert_eq!(iter.num_active_iterators(), min_num);
    let iter = storage
        .scan(
        ...
        .unwrap();
    println!("test 5 num iterators: {}", iter.num_active_iterators());
    assert_eq!(iter.num_active_iterators(), min_num);
    let iter = storage
        .scan(
        ...
        .unwrap();
    println!("test 6 num iterators: {}", iter.num_active_iterators());
